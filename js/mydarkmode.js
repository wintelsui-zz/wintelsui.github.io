	...
	default = void 0;
		var a = function() {
			function e(t) { !
				...
				y.innerHTML = c,
				p.classList.add("darkmode-layer"),
				g.classList.add("darkmode-background");
				var b = "true" === window.localStorage.getItem("darkmode"),
				k = m && window.matchMedia("(prefers-color-scheme: dark)").matches,
				h = null === window.localStorage.getItem("darkmode"); (!0 === b && u || h && k) && (p.classList.add("darkmode-layer--expanded", "darkmode-layer--simple", "darkmode-layer--no-transition"), y.classList.add("darkmode-toggle--white"), document.body.classList.add("darkmode--activated")),
...
//					n.classList.add("darkmode-layer--button"),
						...
						n.classList.remove("darkmode-layer--simple"), setTimeout(function() {
													n.classList.remove("darkmode-layer--no-transition"),
													n.classList.remove("darkmode-layer--expanded")
												},
												1)
//						n.classList.add("darkmode-layer--expanded"), setTimeout(function() {
